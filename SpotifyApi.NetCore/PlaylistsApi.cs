...
namespace SpotifyApi.NetCore
{
    ...
    public class PlaylistsApi : SpotifyWebApi, IPlaylistsApi
    {
        ...
        public Task<PlaylistsSearchResult> GetPlaylists(
            string username,
            string accessToken = null,
            int? limit = null,
            int offset = 0)
            => GetPlaylists<PlaylistsSearchResult>(username, accessToken);
            ...
            int offset = 0)
        {
            ...
            var builder = new UriBuilder($"{BaseUrl}/users/{Uri.EscapeDataString(username)}/playlists");
